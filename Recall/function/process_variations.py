...
def process_variation(driver, model_names, attention, no_brand, method, id):
    ...
    try:
        ...
        for link in links:
            ...
            if not pass_tracking(driver=driver, link=link, list_css=['div.WBVL_7'], timewait=30, loops=1):
                continue
            ...
            if not pass_tracking(driver=driver, link=link, list_css=['div.v-center'], timewait=30, loops=1):
                continue
